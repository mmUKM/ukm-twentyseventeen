            ...
            ?>
                <li>
                    <div uk-grid>
                        ...
                        <div class="uk-width-1-1 uk-width-5-6@s uk-margin-remove"><a href="<?php echo get_post_meta( $post->ID, 'ut_pekeliling_file', true ); ?>"><?php the_title(); ?></a></div>
                    </div>
                </li>
            <?php endwhile; else: ?>
