...
<article class="large-12-12 article"></article>
    ...
    ?>
    <div class="bottom-divider <?php if ( $hide_consultation == 1 ) { echo 'hidden'; } ?>">
    ...
    <div class="bottom-divider <?php if ( $hide_journal == 1 ) { echo 'hidden'; } ?>">
    ...
    <div class="bottom-divider <?php if ( $hide_monograph == 1 ) { echo 'hidden'; } ?>">
    ...
    <div class="bottom-divider <?php if ( $hide_reports == 1 ) { echo 'hidden'; } ?>">
    ...
    <div class="bottom-divider <?php if ( $hide_research_grant == 1 ) { echo 'hidden'; } ?>">
    ...
    <div class="bottom-divider <?php if ( $hide_teaching == 1 ) { echo 'hidden'; } ?>">
